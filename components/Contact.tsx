...
export default function Contact() {
  ...
  return (
    <>
      <div className="bg-[url('../img/BostonCity.jpg')] bg-stretch bg-top w-full h-[100vh] flex justify-center items-center ">
        <div className='flex flex-row flex-wrap sm:h-[80%] h-[670px] w-[80%] bg-[rgba(0,0,0,.7)] justify-around items-center sm:ml-[150px]'>
          ...
          <form ref={form} onSubmit={sendEmail} className='flex flex-col gap-10 relative sm:pl-10 sm:pr-10 justify-center items-center'>
            <div className='flex flex-col justify-center items-center w-[100%]'>
              <label className='text-white flex'>Name</label>
              <input className='rounded w-[70%] text-black p-2' type="text" name="user_name" placeholder='John Doe...'/>
            </div>

            <div className='flex flex-col justify-center items-center w-[100%]'>
              <label className='text-white flex'>Email</label>
              <input className='rounded w-[70%] text-black p-2' type="email" name="user_email"  placeholder='JohnDoe@gmail.com'/>
            </div>

            <div className='flex flex-col sm:w-[400px] h-[200px] justify-center items-center w-[100%]'>
              <label className='text-white flex'>Message</label>
